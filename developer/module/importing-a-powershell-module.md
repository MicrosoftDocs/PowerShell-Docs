...
-   Using the [Get-Help](http://go.microsoft.com/fwlink/?LinkID=113316) cmdlet to get help for a cmdlet. For example, typing `Get-Help Get-WinEvent` imports the Microsoft.PowerShell.Diagnostics module that contains the **Get-WinEvent** cmdlet.
