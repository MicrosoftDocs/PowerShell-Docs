...
2.  If you wish to control user access to certain functions or properties, call [Export-ModuleMember](http://go.microsoft.com/fwlink/?LinkID=141551) at the end of your script.
...
7.  To remove a module from active service, make a call to [Remove-Module](http://go.microsoft.com/fwlink/?LinkId=141556).
     ...
     Note that [Remove-Module](http://go.microsoft.com/fwlink/?LinkId=141556) removes your module from active memory - it does not actually delete it from where you saved the module files.
