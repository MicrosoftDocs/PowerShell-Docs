...
-   [Defining the Windows PowerShell Item Provider Class](#derivefromitemcmdletprovider)

-   [Defining Base Functionality](#defineingbasefunctionality)

-   [Checking for Path Validity](#checkpathvalidity)

-   [Determining if an Item Exists](#determineifitemexists)

-   [Attaching Dynamic Parameters to the Test-Path Cmdlet](#retrievedynamicparamsitemexists)

-   [Retrieving an Item](#retrieveitem)

-   [Attaching Dynamic Parameters to the Get-Item Cmdlet](#retrievedynamicparamsgetitem)

-   [Setting an Item](#setitem)

-   [Attaching Dynamic Parameters to the Set-Item Cmdlet](#retrievedynamicparamssetitem)

-   [Clearing an Item](#clearitem)

-   [Attaching Dynamic Parameters to the Cler-Item Cmdlet](#retrievedynamicparamsclearitem)

-   [Performing a Default Action for an Item](#invokedefaultaction)

-   [Retrieving Dynamic Parameters for InvokeDefaultAction](#retrievedynamicparamsinvokedefaultaction)

-   [Implementing Helper Methods and Classes](#implementhelpermethodsandclasses)

-   [Code Sample](#codesampleitemaccessdb3)

-   [Defining Object Types and Formatting](#defineobjecttypesformattingitemprovider)

-   [Building the Windows PowerShell Provider](#buildprovideritemaccessdb3)

-   [Testing the Windows PowerShell Provider](#testprovideritemaccessdb3)
...
##  <a name="definingbasefunctionality"></a> Defining Base Functionality
...
##  <a name="checkpathvalidity"></a> Checking for Path Validity
...
##  <a name="retrievedynamicparamsitemexists"></a> Attaching Dynamic Parameters to the Test-Path Cmdlet
...
##  <a name="retrievedynamicparamsgetitem"></a> Attaching Dynamic Parameters to the Get-Item Cmdlet
...
##  <a name="retrievedynamicparamssetitem"></a> Retrieving Dynamic Parameters for SetItem
...
##  <a name="retrievedynamicparamsclearitem"></a> Retrieve Dynamic Parameters for ClearItem
...
##  <a name="retrievedynamicparamsinvokedefaultaction"></a> Retrieve Dynamic Parameters for InvokeDefaultAction
...
##  <a name="codesampleitemaccessdb3"></a> Code Sample
...
##  <a name="defineobjecttypesformattingitemprovider"></a> Defining Object Types and Formatting
 When writing a provider, it may be necessary to add members to existing objects or define new objects. When finished, create a Types file that Windows PowerShell can use to identify the members of the object and a Format file that defines how the object is displayed. For more information about , see [Extending Object Types and Formatting &#91;ps&#93;](http://msdn.microsoft.com/en-us/da976d91-a3d6-44e8-affa-466b1e2bd351).
 When writing a provider, it may be necessary to add members to existing objects or define new objects. When finished, create a Types file that Windows PowerShell can use to identify the members of the object and a Format file that defines how the object is displayed. For more information about , see [Extending Object Types and Formatting &#91;ps&#93;](http://msdn.microsoft.com/en-us/da976d91-a3d6-44e8-affa-466b1e2bd351).

##  <a name="buildprovideritemaccessdb3"></a> Building the Windows PowerShell provider
...
##  <a name="testprovideritemaccessdb3"></a> Testing the Windows PowerShell provider
