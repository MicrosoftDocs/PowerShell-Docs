...
-   [Defining a Windows PowerShell Container Provider Class](#definecmdletprovidercontainer)

-   [Defining Base Functionality](#definingbasefunctionality)

-   [Retrieving Child Items](#retrievechilditemscontainer)

-   [Attaching Dynamic Parameters to the Get-ChildItem Cmdlet](#retrievedynamicparamsgetchilditems)

-   [Retrieving Child Item Names](#retrievechildnamescontainer)

-   [Attaching Dynamic Parameters to the Get-ChildItem Cmdlet (Name)](#retrievedynamicparamsgetchildname)

-   [Renaming Items](#renameitemcontainer)

-   [Attaching Dynamic Parameters to the  Rename-Item Cmdlet](#retrievedynamicparamsrenameitem)

-   [Creating New Items](#setnewitemcontainer)

-   [Attaching Dynamic Parameters to the New-Item Cmdlet](#retrievedynamicparamsnewitem)

-   [Removing a Items](#removeitemcontainer)

-   [Attaching Dynamic Parameters to the Remove-Item Cmdlet](#retrievedynamicparamsremoveitem)

-   [Querying for Child Items](#queryforchilditemscontainer)

-   [Coping Items](#copyitemcontainer)

-   [Attaching Dynamic Parameters to the  Copy-Item Cmdlet](#retrievedynamicparamscopyitem)

-   [Code Sample](#codesamplecontaineraccessdb4)

-   [Defining Object Types and Formatting](#defineobjecttypesformattingitemprovider)

-   [Building the Windows PowerShell Provider](#buildcmdletprovidercontainer)

-   [Testing the Windows PowerShell Provider](#testcmdletprovidercontainer)
...
##  <a name="defineingbasefunctionality"></a> Defining Base Functionality
...
##  <a name="retrievechilditemscontainer"></a> Retrieving Child Items
...
##  <a name="retrievedynamicparamsgetchilditems"></a> Attaching Dynamic Parameters to the Get-ChildItem Cmdlet
...
##  <a name="retrievedynamicparamsgetchildname"></a> Attaching Dynamic Parameters to the Get-ChildItem Cmdlet (Name)
...
##  <a name="retrievedynamicparamsrenameitem"></a> Attaching Dynamic Parameters to the Rename-Item Cmdlet
...
##  <a name="retrievedynamicparamsnewitem"></a> Attaching Dynamic Parameters to the New-Item Cmdlet
...
##  <a name="retrievedynamicparamsremoveitem"></a> Attaching Dynamic Parameters to the Remove-Item Cmdlet
...
##  <a name="copyitemcontainer"></a> Copying Items
...
1.  Run the Get-ChildItem cmdlet to retrieve the list of child items from a Customers table in the Access database.
    ...
    ```
    PS> get-childitem mydb:customers
    ```
...
2.  Run the Get-ChildItem cmdlet again to retrieve the data of a table.
    ...
    ```
    PS> (get-childitem mydb:customers).data
    ```
...
4.  Reuse Get-Item to retrieve the data for the items in row 0.
    ...
    ```
    PS> (get-item mydb:\customers\0).data
    ```
...
5.  Now use the New-Item cmdlet to add a row to an existing table. The `Path` parameter specifies the full path to the row, and must indicate a row number that is greater than the existing number of rows in the table. The `Type` parameter indicates "row" to specify that type of item to add. Finally, the `Value` parameter specifies a comma-delimited list of column values for the row.
    ...
    ```
    PS mydb:\> new-item -Path mydb:\Customers\3 -type "row" -Value "3,CustomerFirstName,CustomerLastName,CustomerEmailAdress,CustomerTitle,CustomerCompany,CustomerPhone, CustomerAddress,CustomerCity,CustomerState,CustomerZip,CustomerCountry"
    ```
