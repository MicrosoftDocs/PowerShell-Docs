...
##  <a name="definecmdletstopproc3"></a> Defining the Cmdlet
...
##  <a name="defineparametersforsystemmodstopproc3"></a> Defining Parameters for System Modification
...
##  <a name="defineparameteralias"></a> Defining a Parameter Alias
...
##  <a name="createhelpforparameters"></a> Creating Help for Parameters
...
##  <a name="provideinputprocessingstopproc3"></a> Overriding an Input Processing Method
...
##  <a name="supportexpansion"></a> Supporting Wildcard Expansion
...
##  <a name="codesamplealiasesstopproc3"></a> Code Sample
 For the complete C# sample code, see [StopProcessSample03 Sample](./stopprocesssample03-sample.md).

##  <a name="defineobjecttypesformattingstopproc3"></a> Define Object Types and Formatting
...
##  <a name="buildcmdletstopproc3"></a> Building the Cmdlet
...
##  <a name="testcmdletstopproc3"></a> Testing the Cmdlet
