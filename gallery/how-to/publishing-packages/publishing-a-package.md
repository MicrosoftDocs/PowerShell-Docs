...
- Tags - it is a strong recommendation to tag your package based on its compatibility with PSEditions and platforms (see [publishing guidlines](/powershell/gallery/concepts/publishing-guidelines) for details)
