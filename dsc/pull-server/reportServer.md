...
see [Configuring the Local Configuration Manager](../managing-nodes/metaConfig.md)). The server to which the node sends reports must be set up as a web pull server (you cannot send reports
