...
Locale: en-US
ms.date: 04/08/2026
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.core/about/about_character_encoding?view=powershell-7.7&WT.mc_id=ps-gethelp
schema: 2.0.0
...
of all aspects of Unicode, refer to [The Unicode Standard][08].
...
more information, see the [Byte order mark][03] documentation.
...
In general, Windows PowerShell uses the Unicode [UTF-16LE][07] encoding by
...
see the .NET documentation for [Encoding.CodePage][01].
...
PowerShell has three default variables that control the default encoding
behavior.
...
- [Byte order mark][06]
- [Code Pages - Win32 apps][04]
- [Encoding.CodePage][01]
- [Introduction to character encoding in .NET][02]
- [The Unicode Standard][08]
- [UTF-16LE][07]

<!-- link references -->
[01]: /dotnet/api/system.text.encoding.codepage
[02]: /dotnet/standard/base-types/character-encoding-introduction
[03]: /globalization/encoding/byte-order-mark
[04]: /windows/win32/intl/code-pages
[05]: about_Preference_Variables.md
[06]: https://wikipedia.org/wiki/Byte_order_mark
[07]: https://wikipedia.org/wiki/UTF-16
[08]: https://www.unicode.org/standard/standard.html
