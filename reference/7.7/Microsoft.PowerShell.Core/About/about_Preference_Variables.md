...
Locale: en-US
ms.date: 04/02/2026
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.core/about/about_preference_variables?view=powershell-7.7&WT.mc_id=ps-gethelp
schema: 2.0.0
...
| ------------------------------------------------ | ---------------------------------------------------------------- |
| [`$ConfirmPreference`][03]                       | [`High`][57]                                                     |
| [`$DebugPreference`][04]                         | [`SilentlyContinue`][56]                                         |
| [`$ErrorActionPreference`][05]                   | [`Continue`][56]                                                 |
| [`$ErrorView`][06]                               | [`ConciseView`][59]                                              |
| [`$FormatEnumerationLimit`][07]                  | `4`                                                              |
| [`$InformationPreference`][08]                   | [`SilentlyContinue`][56]                                         |
...
| [`$OutputEncoding`][12]                          | [`UTF8Encoding`][67] object                                      |
| [`$ProgressPreference`][13]                      | [`Continue`][56]                                                 |
...
| [`$PSSessionOption`][22]                         | [`PSSessionOption`][62] object                                   |
| [`$PSStyle`][23]                                 | [`PSStyle`][61] object                                           |
| [`$Transcript`][24]                              | `$null` (none)                                                   |
| [`$VerbosePreference`][25]                       | [`SilentlyContinue`][56]                                         |
| [`$WarningPreference`][26]                       | [`Continue`][56]                                                 |
...
> which preference was used. For more information, see [about_Scopes][43].
...
profile. For more information, see [about_Profiles][39].
...
For more information about remote commands, see [about_Remote][42].
...
The `$ConfirmPreference` variable takes one of the [`ConfirmImpact`][57]
...
[about_Functions_CmdletBindingAttribute][33].
...
The `$DebugPreference` variable takes one of the [`ActionPreference`][56]
...
[`ActionPreference`][56] enumeration values: **SilentlyContinue**, **Stop**,
...
more information about error categories, see [about_Error_Handling][32]. For
...
[$PSNativeCommandUseErrorActionPreference][19].
...
The `$ErrorView` variable takes one of the [`ErrorView`][59] enumeration
...
table, see [about_Hash_Tables][34]. For more information, see the examples in
[Format-Table][49].
...
[Write-Information][52] cmdlet. If the **InformationAction** parameter is used,
...
- `$LogProviderLifecycleEvent`: Logs adding and removing of PowerShell
  ...
  providers, see [about_Providers][40].
...
in your PowerShell profile. For more information, see [about_Profiles][39].
...
cmdlet. For more information, see [about_History][35].
...
as [**ASCIIEncoding**][63], [**UTF7Encoding**][66], [**UTF8Encoding**][67],
[**UTF32Encoding**][65], and [**UnicodeEncoding**][64].

**Default**: [UTF8Encoding][67] object.
...
value is encoded using the [**UTF8Encoding**][67] scheme.
...
[Write-Progress][53] cmdlet. The `Write-Progress` cmdlet creates progress bars
that show a command's status.

The `$ProgressPreference` variable takes one of the [`ActionPreference`][56]
enumeration values: **SilentlyContinue**, **Stop**, **Continue**, **Inquire**,
**Ignore**, **Suspend**, or **Break**.
...
This variable was introduced in PowerShell 7.7-preview.1.
...
- `wsl.exe` - Always uses [**UnicodeEncoding**][64]
- `winget.exe` - Always uses [**UTF8Encoding**][67]
- `python.exe` - Uses the Windows locale encoding or [**UTF8Encoding**][67] if
...
[**UnicodeEncoding**][64] which means you need to tell PowerShell to use that
...
[about_Parameters_Default_Values][37].
...
[`PSModuleAutoLoadingPreference`][60] enumeration values:
...
behavior, see [about_Parsing][38].

PowerShell 7.3 also added the ability to trace parameter binding for native
commands. For more information, see [Trace-Command][51].
...
or **ApplicationName** parameters of the [New-PSSession][47],
[Enter-PSSession][45], or [Invoke-Command][46] cmdlets.
...
information, see [System.Management.Automation.Remoting.PSSessionOption][62].
...
[New-PSSessionOption][48]. For more information about remote commands and
sessions, see [about_Remote][42] and [about_PSSessions][41].
...
cmdlet, or provider, such as the messages generated by the [Write-Verbose][54]
...
The `$VerbosePreference` variable takes one of the [`ActionPreference`][56]
enumeration values: **SilentlyContinue**, **Stop**, **Continue**, **Inquire**,
**Ignore**, **Suspend**, or **Break**.
...
cmdlet, or provider, such as the messages generated by the [Write-Warning][55]
cmdlet.
...
The `$WarningPreference` variable takes one of the [`ActionPreference`][56]
enumeration values: **SilentlyContinue**, **Stop**, **Continue**, **Inquire**,
**Ignore**, **Suspend**, or **Break**.
...
[32]: about_Error_Handling.md
[33]: about_Functions_CmdletBindingAttribute.md
[34]: about_Hash_Tables.md
[35]: about_History.md
[36]: about_Modules.md
[37]: about_Parameters_Default_Values.md
[38]: about_parsing.md
[39]: about_Profiles.md
[40]: about_Providers.md
[41]: about_PSSessions.md
[42]: about_Remote.md
[43]: about_Scopes.md
[44]: about_Variables.md
[45]: xref:Microsoft.PowerShell.Core.Enter-PSSession
[46]: xref:Microsoft.PowerShell.Core.Invoke-Command
[47]: xref:Microsoft.PowerShell.Core.New-PSSession
[48]: xref:Microsoft.PowerShell.Core.New-PSSessionOption
[49]: xref:Microsoft.PowerShell.Utility.Format-Table
[50]: xref:Microsoft.PowerShell.Utility.Send-MailMessage
[51]: xref:Microsoft.PowerShell.Utility.Trace-Command
[52]: xref:Microsoft.PowerShell.Utility.Write-Information
[53]: xref:Microsoft.PowerShell.Utility.Write-Progress
[54]: xref:Microsoft.PowerShell.Utility.Write-Verbose
[55]: xref:Microsoft.PowerShell.Utility.Write-Warning
[56]: xref:System.Management.Automation.ActionPreference
[57]: xref:System.Management.Automation.ConfirmImpact
[58]: xref:System.Management.Automation.ErrorCategoryInfo
[59]: xref:System.Management.Automation.ErrorView
[60]: xref:System.Management.Automation.PSModuleAutoLoadingPreference
[61]: xref:System.Management.Automation.PSStyle
[62]: xref:System.Management.Automation.Remoting.PSSessionOption
[63]: xref:System.Text.ASCIIEncoding
[64]: xref:System.Text.UnicodeEncoding
[65]: xref:System.Text.UTF32Encoding
[66]: xref:System.Text.UTF7Encoding
[67]: xref:System.Text.UTF8Encoding
