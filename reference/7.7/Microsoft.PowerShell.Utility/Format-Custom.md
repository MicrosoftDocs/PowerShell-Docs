...
ms.date: 04/08/2026
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.utility/format-custom?view=powershell-7.7&WT.mc_id=ps-gethelp
schema: 2.0.0
aliases:
  - fc
title: Format-Custom
...
Specifies the properties that you don't want to display in the table. Type one or more property
names, separated by commas. Wildcards are permitted. You can combine the **ExcludeProperty**
parameter with the **Property** parameter to limit the properties that are displayed.
