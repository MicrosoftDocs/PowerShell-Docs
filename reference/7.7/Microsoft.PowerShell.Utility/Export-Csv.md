...
ms.date: 04/08/2026
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.utility/export-csv?view=powershell-7.7&WT.mc_id=ps-gethelp
schema: 2.0.0
aliases:
  - epcsv
title: Export-Csv
...
Beginning with PowerShell 7.7, using the **Append** parameter with the **NoHeader** parameter throws
an error message instead of accepting the invalid combination and creating a headerless CSV file
that causes subsequent append operations to fail.
