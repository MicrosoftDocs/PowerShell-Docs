...
ms.date: 06/16/2026
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.utility/set-variable?view=powershell-7.7&WT.mc_id=ps-gethelp
schema: 2.0.0
aliases:
  - set
  - sv
...
The **Value** parameter accepts object input from the pipeline by value or from objects with a
**Value** property.
