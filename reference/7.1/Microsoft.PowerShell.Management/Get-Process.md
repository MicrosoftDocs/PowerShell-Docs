...
ms.date: 06/09/2017
online version: https://docs.microsoft.com/powershell/module/microsoft.powershell.management/get-process?view=powershell-7.x&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Get-Process
---
# Get-Process
...
This example provides a `Format-Table` command that adds the **MachineName** property to the
