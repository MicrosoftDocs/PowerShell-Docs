...
ms.date: 06/09/2017
online version: https://docs.microsoft.com/powershell/module/microsoft.powershell.core/get-job?view=powershell-7.x&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Get-Job
---
# Get-Job
...
The second command uses the **Get-Job** cmdlet to get the job. The command uses the dot method to
