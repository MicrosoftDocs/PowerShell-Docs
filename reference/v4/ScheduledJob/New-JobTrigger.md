...
```
New-JobTrigger [-Once] [-RandomDelay <TimeSpan>] [-RepeatIndefinitely] [-RepetitionDuration <TimeSpan>]
 [-RepetitionInterval <TimeSpan>] -At <DateTime>
```

### UNNAMED_PARAMETER_SET_2
```
New-JobTrigger [-Weekly] [-RandomDelay <TimeSpan>] [-WeeksInterval <Int32>] -At <DateTime>
 -DaysOfWeek <DayOfWeek[]>
```

### UNNAMED_PARAMETER_SET_3
```
New-JobTrigger [-Daily] [-DaysInterval <Int32>] [-RandomDelay <TimeSpan>] -At <DateTime>
```

### UNNAMED_PARAMETER_SET_4
```
New-JobTrigger [-AtLogOn] [-RandomDelay <TimeSpan>] [-User <String>]
```

### UNNAMED_PARAMETER_SET_5
```
New-JobTrigger [-AtStartup] [-RandomDelay <TimeSpan>]
```
...
## NOTES
Job triggers are not saved to disk.
However, scheduled jobs are saved to disk, and you can use the Get-JobTrigger to get the job trigger of any scheduled job.
