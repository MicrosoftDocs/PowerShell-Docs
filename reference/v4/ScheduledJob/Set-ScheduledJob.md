...
Set-ScheduledJob [-InputObject] <ScheduledJobDefinition> [-ArgumentList <Object[]>]
 ...
 [-MaxResultCount <Int32>] [-Name <String>] [-PassThru] [-RunAs32] [-RunNow]
 [-ScheduledJobOption <ScheduledJobOptions>] [-ScriptBlock <ScriptBlock>] [-Trigger <ScheduledJobTrigger[]>]
```
...
Set-ScheduledJob [-InputObject] <ScheduledJobDefinition> [-ArgumentList <Object[]>]
 ...
 [-RunNow] [-ScheduledJobOption <ScheduledJobOptions>] [-Trigger <ScheduledJobTrigger[]>]
```
