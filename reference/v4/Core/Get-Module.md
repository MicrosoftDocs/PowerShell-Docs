...
```
Get-Module [[-FullyQualifiedName] <String[]>] [[-Name] <String[]>] [-All]
```

### UNNAMED_PARAMETER_SET_2
```
Get-Module [[-FullyQualifiedName] <String[]>] [[-Name] <String[]>] [-All] [-Refresh] [-ListAvailable]
```
...
```
Get-Module [[-FullyQualifiedName] <String[]>] [[-Name] <String[]>] [-ListAvailable] [-Refresh]
 -PSSession <PSSession>
```
