...
Register-PSRepository -Name <String> -SourceLocation <Uri> [-PublishLocation <Uri>]
 [-ScriptSourceLocation <Uri>] [-ScriptPublishLocation <Uri>] [-InstallationPolicy <String>]
...
A repository's installation policy specifies PowerShellGet behavior when installing from that repository.
