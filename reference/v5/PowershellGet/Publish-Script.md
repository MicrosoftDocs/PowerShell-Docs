...
```
Publish-Script -Path <String> [-NuGetApiKey <String>] [-Repository <String>] [-WhatIf] [-Confirm]
```

### LiteralPathParameterSet
```
Publish-Script -LiteralPath <String> [-NuGetApiKey <String>] [-Repository <String>] [-WhatIf] [-Confirm]
```
