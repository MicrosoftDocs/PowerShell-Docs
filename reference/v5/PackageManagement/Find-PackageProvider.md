...
Find-PackageProvider [[-Name] <String[]>] [-AllVersions] [-Source <String[]>] [-IncludeDependencies]
 [-Credential <PSCredential>] [-RequiredVersion <String>] [-MinimumVersion <String>] [-MaximumVersion <String>]
...
### -AllVersions
Indicates that Find-PackageProvider returns all available versions of the package provider.
