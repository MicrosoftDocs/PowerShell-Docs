...
### Id (Default)
```
Remove-PSSession [-Id] <Int32[]> [-WhatIf] [-Confirm]
```

### Session
```
Remove-PSSession [-Session] <PSSession[]> [-WhatIf] [-Confirm]
```

### InstanceId
```
Remove-PSSession -InstanceId <Guid[]> [-WhatIf] [-Confirm]
```

### Name
```
Remove-PSSession -Name <String[]> [-WhatIf] [-Confirm]
```

### ComputerName
```
Remove-PSSession [-ComputerName] <String[]> [-WhatIf] [-Confirm]
```
