...
```
Remove-Job [-Force] [-Id] <Int32[]> [-WhatIf] [-Confirm]
```

### JobParameterSet
```
Remove-Job [-Job] <Job[]> [-Force] [-WhatIf] [-Confirm]
```

### NameParameterSet
```
Remove-Job [-Force] [-Name] <String[]> [-WhatIf] [-Confirm]
```

### InstanceIdParameterSet
```
Remove-Job [-Force] [-InstanceId] <Guid[]> [-WhatIf] [-Confirm]
```

### FilterParameterSet
```
Remove-Job [-Force] [-Filter] <Hashtable> [-WhatIf] [-Confirm]
```

### StateParameterSet
```
Remove-Job [-State] <JobState> [-WhatIf] [-Confirm]
```

### CommandParameterSet
```
Remove-Job [-Command <String[]>] [-WhatIf] [-Confirm]
```
