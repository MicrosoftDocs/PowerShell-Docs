...
```
Get-Job [[-Id] <Int32[]>] [-After <DateTime>] [-Before <DateTime>] [-ChildJobState] [-HasMoreData <Boolean>]
 [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-Job [-After <DateTime>] [-Before <DateTime>] [-ChildJobState] [-Command <String[]>]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_3
```
Get-Job [-Filter] <Hashtable>
```

### UNNAMED_PARAMETER_SET_4
```
Get-Job [-State] [-After <DateTime>] [-Before <DateTime>] [-ChildJobState] [-HasMoreData <Boolean>]
 [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_5
```
Get-Job [-Name] <String[]> [-After <DateTime>] [-Before <DateTime>] [-ChildJobState] [-HasMoreData <Boolean>]
 [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_6
```
Get-Job [-InstanceId] <Guid[]> [-After <DateTime>] [-Before <DateTime>] [-ChildJobState]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```
