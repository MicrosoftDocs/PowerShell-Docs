...
```
Get-Help [[-Name] <String>] [-Category] [-Component <String[]>] [-Full] [-Functionality <String[]>]
 [-Path <String>] [-Role <String[]>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-Help [[-Name] <String>] [-Category] [-Component <String[]>] [-Functionality <String[]>] [-Path <String>]
 [-Role <String[]>] [-Detailed]
```

### UNNAMED_PARAMETER_SET_3
```
Get-Help [[-Name] <String>] [-Category] [-Component <String[]>] [-Functionality <String[]>] [-Path <String>]
 [-Role <String[]>] [-Examples]
```
...
```
Get-Help [[-Name] <String>] [-Category] [-Component <String[]>] [-Functionality <String[]>] [-Path <String>]
 [-Role <String[]>] -Parameter <String>
```

### UNNAMED_PARAMETER_SET_6
```
Get-Help [[-Name] <String>] [-Category] [-Component <String[]>] [-Functionality <String[]>] [-Path <String>]
 [-Role <String[]>] [-ShowWindow]
```
