...
```
Invoke-Command -Credential <PSCredential> [-ThrottleLimit <Int32>] [-AsJob] [-HideComputerName]
 [-FilePath] <String> [-InputObject <PSObject>] [-ArgumentList <Object[]>] [-VMId] <Guid[]>
```
...
Invoke-Command [-Credential <PSCredential>] [-ConfigurationName <String>] [-ThrottleLimit <Int32>]
 ...
 [-ArgumentList <Object[]>] [-CertificateThumbprint <String>]
```
...
```
Invoke-Command -Credential <PSCredential> [-ThrottleLimit <Int32>] [-AsJob] [-HideComputerName]
 [-ScriptBlock] <ScriptBlock> [-InputObject <PSObject>] [-ArgumentList <Object[]>] [-VMId] <Guid[]>
```
...
### ContainerId
```
Invoke-Command [-ThrottleLimit <Int32>] [-AsJob] [-HideComputerName] [-JobName <String>]
 [-ScriptBlock] <ScriptBlock> [-RunAsAdministrator] [-InputObject <PSObject>] [-ArgumentList <Object[]>]
 -ContainerId <String[]>
```

### FilePathContainerId
```
Invoke-Command [-ThrottleLimit <Int32>] [-AsJob] [-HideComputerName] [-JobName <String>] [-FilePath] <String>
 [-RunAsAdministrator] [-InputObject <PSObject>] [-ArgumentList <Object[]>] -ContainerId <String[]>
```
...
### FilePathContainerName
```
Invoke-Command [-ThrottleLimit <Int32>] [-AsJob] [-HideComputerName] [-JobName <String>] [-FilePath] <String>
 [-RunAsAdministrator] [-InputObject <PSObject>] [-ArgumentList <Object[]>] -ContainerName <String[]>
```
...
```yaml
Type: SwitchParameter
Parameter Sets: Session, FilePathRunspace, ComputerName, FilePathComputerName, FilePathVMName, FilePathVMId, Uri, FilePathUri, VMId, VMName, ContainerId, FilePathContainerId, ContainerName, FilePathContainerName
Aliases: 
...
```yaml
Type: String[]
Parameter Sets: ContainerName, FilePathContainerName
Aliases: 
...
```yaml
Type: String
Parameter Sets: FilePathRunspace, FilePathComputerName, FilePathVMName, FilePathVMId, FilePathUri, FilePathContainerId, FilePathContainerName
Aliases: PSPath
...
```yaml
Type: String
Parameter Sets: Session, FilePathRunspace, ComputerName, FilePathComputerName, Uri, FilePathUri, ContainerId, FilePathContainerId, ContainerName, FilePathContainerName
Aliases: 
...
```yaml
Type: SwitchParameter
Parameter Sets: ContainerId, FilePathContainerId, ContainerName, FilePathContainerName
Aliases: 
...
```yaml
Type: ScriptBlock
Parameter Sets: InProcess, Session, ComputerName, Uri, VMId, VMName, ContainerId, ContainerName
Aliases: Command
