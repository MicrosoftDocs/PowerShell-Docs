...
ms.date: 04/23/2019
online version: https://docs.microsoft.com/powershell/module/microsoft.powershell.utility/export-pssession?view=powershell-3.0
schema: 2.0.0
...
<Object[]>] [-CommandType <CommandTypes>] [-Module <string[]>] [-Certificate <X509Certificate2>]
[<CommonParameters>]
```
