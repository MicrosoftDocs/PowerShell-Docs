...
```powershell
Add-Content -Value (Get-Content "test.log") -Path "C:\Tests\logs\test134.log"
```
...
```powershell
Add-Content -Path C:\Test\IsReadOnlyTextFile.txt -Value "Add value to read only text file" -Force
```
