...
Changes the security descriptor of a specified item.
The ability to manage a security descriptor can be extended to additional providers that support Powershell Objects.
...
central access policies for users and groups.
...
There may be additional providers that also support this interface, or extend it.
For example, the Active Directory Provider defines a new ActiveDirectoryAccessRule class to implement the security descriptor extensions used by Active Directory.
