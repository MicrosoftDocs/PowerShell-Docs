...
```powershell
dir $home\AppData\Local\Microsoft\Windows\PowerShell\ScheduledJobs\ProcessJob
```
...
```powershell
dir $home\AppData\Local\Microsoft\Windows\PowerShell\ScheduledJobs\ProcessJob\Output
```
...
```powershell
dir $home\AppData\Local\Microsoft\Windows\PowerShell\ScheduledJobs\ProcessJob\Output\20111102-030002-260
```
