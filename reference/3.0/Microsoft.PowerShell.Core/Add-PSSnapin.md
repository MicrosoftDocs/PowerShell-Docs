...
- For more information about snap-ins, see About/about_PSSnapins.md and [How to Create a Windows PowerShell Snap-in](https://go.microsoft.com/fwlink/?LinkId=144762) in the MSDN library.
...
- You can add any snap-in that has been registered by using the Microsoft .NET Framework install utility. For more information, see https://go.microsoft.com/fwlink/?LinkID=143619 in the MSDN library.
