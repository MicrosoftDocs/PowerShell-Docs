...
```
PS C:\> (Invoke-WebRequest -Uri "https://msdn.microsoft.com/library/aa973757(v=vs.85).aspx").Links.Href
```
...
To test a website with the standard user agent string that is used by most Internet browsers, use the properties of the [PSUserAgent](https://msdn.microsoft.com/library/windows/desktop/hh484857&#40;v=vs.85&#41;) class, such as Chrome, FireFox, InternetExplorer, Opera, and Safari.
