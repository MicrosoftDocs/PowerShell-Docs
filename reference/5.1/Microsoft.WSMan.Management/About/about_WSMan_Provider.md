...
@Microsoft.WsMan.Management.Connect-WSMan. Once a connection is made to a remote
...
@Microsoft.PowerShell.Core.Get-Help command in a file
system drive or use the `-Path` parameter of
@Microsoft.PowerShell.Core.Get-Help to specify a file
system drive.
