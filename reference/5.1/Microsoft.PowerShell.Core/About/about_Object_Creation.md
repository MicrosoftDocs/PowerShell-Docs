...
This method works only for classes that have a parameterless constructor, that
is, a constructor that has no parameters. The object properties must be public
and settable.
