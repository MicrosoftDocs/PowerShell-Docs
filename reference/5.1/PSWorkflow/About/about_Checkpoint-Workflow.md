...
If a workflow is interrupted, intentionally or unintentionally,  Windows PowerShellï¿½ Workflow automatically uses the data in newest checkpoint to recover and resume the workflow.
