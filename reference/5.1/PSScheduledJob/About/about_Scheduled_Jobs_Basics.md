...
detailed information about job triggers, see the help topic for the @PSScheduledJob.New-JobTrigger
cmdlet.
...
information about the job options, see the help topic for @PSScheduledJob.New-ScheduledJobOption.
