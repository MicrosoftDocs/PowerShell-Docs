...
## DETAILED DESCRIPTION  
 ...
 [Set\-Location &#91;m2&#93;](Set-Location.md) alias:  
 ...
 The Alias provider supports all the cmdlets that have the Item noun except for the [Invoke\-Item &#91;m2&#93;](Invoke-Item.md) cmdlet. And, it supports the [Get\-Content &#91;m2&#93;](Get-Content.md) and [Set\-Content &#91;m2&#93;](Set-Content.md) cmdlets. The Alias provider does not support the cmdlets that have the ItemProperty noun. And, the Alias provider does not support the Filter parameter in any cmdlet.  
  
 All changes to the aliases affect the current session only. To save the changes, add the changes to the Windows PowerShell profile. Or, use the [Export\-Alias &#91;m2&#93;](Export-Alias.md) and [Import\-Alias &#91;m2&#93;](Import-Alias.md) cmdlets.  
...
|ReadOnly|The properties of the alias cannot be changed except by using the Force parameter. You can use [Remove\-Item &#91;m2&#93;](Remove-Item.md) to delete the alias.|  
...
## See Also  
 [about\_Aliases &#91;m2&#93;](about_Aliases.md)   
