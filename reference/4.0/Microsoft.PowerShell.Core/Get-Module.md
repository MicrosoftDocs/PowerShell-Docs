...
online version: https://go.microsoft.com/fwlink/?linkid=289587
...
This command gets the **Microsoft.PowerShell.Management** module by specifying the module's fully
qualified name, with the **FullyQualifiedName** parameter.
The command then pipes the results into `Format-Table`, to format the results as a table with
**Name** and **Version** as the column headings.
