...
### Example 7: Display examples for a cmdlet
```
...
### Example 8: Display parameter help
```
...
### Example 10: Display online version of help
```
...
### Example 11: Display a list of topics that include a word
```
