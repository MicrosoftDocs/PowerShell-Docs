...
ms.date: 07/17/2019
online version: https://docs.microsoft.com/powershell/module/microsoft.powershell.management/set-service?view=powershell-7
schema: 2.0.0
title: Set-Service
---
...
The **SecurityDescriptor** is stored in the `$SDDLToSet` variable. `Set-Service` uses the **Name**
parameter to specify the **BITS** service. The **SecurityDescriptorSddl** parameter uses
`$SDDLToSet` to change the **SecurityDescriptor** for the **BITS** service.
