...
The **All** parameter of the @Microsoft.PowerShell.Core.Get-Command
...
@Microsoft.PowerShell.Utility.Get-Date cmdlet.
...
it with a call to @Microsoft.PowerShell.Management.Get-ChildItem
