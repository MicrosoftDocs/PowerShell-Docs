...
- [PowerShellStandard.Library][], a reference assembly that enables building a single assembly
...
- The [System.Management.Automation][] package, the core PowerShell runtime and engine
