...
wide polices. Microsoft is no longer investing in AppLocker. AppLocker will only receive security fixes. App Control is the preferred application control system for Windows.
