...
We need to specify the **TargetPath**, which is the application folder for Windows PowerShell, and
...
This will force it to close. The `$ie` variable no longer contains a valid reference even though it
