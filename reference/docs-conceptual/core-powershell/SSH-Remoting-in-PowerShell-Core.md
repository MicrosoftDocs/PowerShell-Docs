...
WinRM provides a robust hosting model for PowerShell remote sessions; in constrast, SSH-based remoting doesn't currently support remote endpoint configuration and JEA (Just Enough
Administration).
