...
- CI-CD concepts. A good reference can be found at [The Release Pipeline Model](https://aka.ms/thereleasepipelinemodelpdf).
...
([What are release pipelines?](/azure/devops/pipelines/release/))
