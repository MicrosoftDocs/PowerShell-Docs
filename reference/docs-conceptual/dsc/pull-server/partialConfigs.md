...
description: DSC allows configurations to be delivered in fragments and from multiple sources. The LCM on the target node puts
the fragments together before applying them as a single configuration.
---
