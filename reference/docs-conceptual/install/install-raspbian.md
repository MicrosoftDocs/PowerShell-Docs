...
- PowerShell 7.3.3 - `https://github.com/PowerShell/PowerShell/releases/download/v7.3.3/powershell-7.3.3-linux-arm32.tar.gz`
- PowerShell 7.2.10 - `https://github.com/PowerShell/PowerShell/releases/download/v7.2.10/powershell-7.2.10-linux-arm32.tar.gz`
