...
- PowerShell 7.2.6 - `https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-lts-7.2.6-1.rh.x86_64.rpm`
- PowerShell 7.0.12 - `https://github.com/PowerShell/PowerShell/releases/download/v7.0.12/powershell-lts-7.0.12-1.rhel.7.x86_64.rpm`
...
```sh
sudo yum install https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-lts-7.2.6-1.rh.x86_64.rpm
```

On RHEL 8:

```sh
sudo dnf install https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-lts-7.2.6-1.rh.x86_64.rpm
```
