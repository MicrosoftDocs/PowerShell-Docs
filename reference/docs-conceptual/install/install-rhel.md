...
- PowerShell 7.5 universal package
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.5.5/powershell-7.5.4-1.rh.x86_64.rpm`
- PowerShell 7.4 (LTS) universal package
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.4.14/powershell-7.4.13-1.rh.x86_64.rpm`
...
```sh
sudo dnf install https://github.com/PowerShell/PowerShell/releases/download/v7.5.5/powershell-7.5.4-1.rh.x86_64.rpm
```
