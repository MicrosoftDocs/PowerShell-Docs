...
- PowerShell 7.4 - latest LTS release
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.4.14/powershell-7.4.13-linux-arm32.tar.gz`
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.4.14/powershell-7.4.13-linux-arm64.tar.gz`
- PowerShell 7.5 - latest stable release
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.5.5/powershell-7.5.4-linux-arm32.tar.gz`
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.5.5/powershell-7.5.4-linux-arm64.tar.gz`
