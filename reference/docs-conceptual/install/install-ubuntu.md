...
- PowerShell 7.3.1 (universal package) for any supported version of Ubuntu
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.3.1/powershell_7.3.1-1.deb_amd64.deb`
- PowerShell 7.2.8(universal package) for any supported version of Ubuntu
  - `https://github.com/PowerShell/PowerShell/releases/download/v7.2.8/powershell-lts_7.2.8-1.deb_amd64.deb`
...
sudo dpkg -i powershell-lts_7.3.1-1.deb_amd64.deb
