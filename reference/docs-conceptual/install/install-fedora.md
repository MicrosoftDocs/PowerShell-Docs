...
- PowerShell 7.1.3 - `https://github.com/PowerShell/PowerShell/releases/download/v7.1.3/powershell-7.1.3-1.rhel.7.x86_64.rpm`
- PowerShell 7.0.6 - `https://github.com/PowerShell/PowerShell/releases/download/v7.0.6/powershell-7.0.6-1.rhel.7.x86_64.rpm`
