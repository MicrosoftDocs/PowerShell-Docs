...
$zipfile = 'PowerShell-7.6.5-win-arm64.zip'
...
Expand-Archive .\PowerShell-7.6.5-win-arm64.zip

# Set up remoting to PowerShell 7
Set-Location .\PowerShell-7.6.5-win-arm64
...
Enter-PSSession -ComputerName $deviceIp -Credential Administrator -Configuration PowerShell.7.6.5
```
...
$zipfile = 'PowerShell-7.6.5-win-x64.zip'
...
Expand-Archive -Path C:\PowerShell-7.6.5-win-x64.zip -DestinationPath 'C:\Program Files\PowerShell 7'
```
...
[03]: https://github.com/PowerShell/PowerShell/releases/download/v7.6.5/PowerShell-7.6.5-win-x64.zip
