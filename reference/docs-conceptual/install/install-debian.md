...
- PowerShell 7.2
  - Debian 10 - `https://github.com/PowerShell/PowerShell/releases/download/v7.2.0/powershell_7.2.0-1.debian.10_amd64.deb`
  - Debian 9 - `https://github.com/PowerShell/PowerShell/releases/download/v7.2.0/powershell_7.2.0-1.debian.9_amd64.deb`
- PowerShell 7.1.5
