...
- PowerShell 7.5 - `https://github.com/PowerShell/PowerShell/releases/download/v7.5.5/powershell-7.5.4-linux-musl-x64.tar.gz`
- PowerShell 7.4 (LTS) - `https://github.com/PowerShell/PowerShell/releases/download/v7.4.14/powershell-7.4.13-linux-musl-x64.tar.gz`
...
curl -L https://github.com/PowerShell/PowerShell/releases/download/v7.5.5/powershell-7.5.4-linux-musl-x64.tar.gz -o /tmp/powershell.tar.gz
