...
- PowerShell 7.2.3 - `https://github.com/PowerShell/PowerShell/releases/download/v7.2.3/powershell-7.2.3-linux-alpine-x64.tar.gz`
- PowerShell 7.1.7 - `https://github.com/PowerShell/PowerShell/releases/download/v7.1.7/powershell-7.1.7-linux-alpine-x64.tar.gz`
...
curl -L https://github.com/PowerShell/PowerShell/releases/download/v7.2.3/powershell-7.2.3-linux-alpine-x64.tar.gz -o /tmp/powershell.tar.gz
