...
- [PowerShell-7.2.1-win-x64.msi][x64msi]
- [PowerShell-7.2.1-win-x86.msi][x86msi]
...
- [PowerShell-7.2.1-win-x64.zip][x64zip]
- [PowerShell-7.2.1-win-x86.zip][x86zip]
- [PowerShell-7.2.1-win-arm64.zip][arm64zip]
- [PowerShell-7.2.1-win-arm32.zip][arm32zip]
