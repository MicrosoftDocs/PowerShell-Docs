...
- [PowerShell-7.2.6-win-x64.msi][x64msi]
- [PowerShell-7.2.6-win-x86.msi][x86msi]
...
- [PowerShell-7.2.6-win-x64.zip][x64zip]
- [PowerShell-7.2.6-win-x86.zip][x86zip]
- [PowerShell-7.2.6-win-arm64.zip][arm64zip]
...
[arm64zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-arm64.zip
[x64msi]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x64.msi
[x64zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x64.zip
[x86msi]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x86.msi
[x86zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x86.zip
[72x64msi]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x64.msi
