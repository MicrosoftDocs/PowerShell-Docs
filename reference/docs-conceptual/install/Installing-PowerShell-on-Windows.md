...
- [PowerShell-7.2.4-win-x64.msi][x64msi]
- [PowerShell-7.2.4-win-x86.msi][x86msi]
...
- [PowerShell-7.2.4-win-x64.zip][x64zip]
- [PowerShell-7.2.4-win-x86.zip][x86zip]
- [PowerShell-7.2.4-win-arm64.zip][arm64zip]
- [PowerShell-7.2.4-win-arm32.zip][arm32zip]
...
[arm32zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-arm32.zip
[arm64zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-arm64.zip
[x64msi]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-x64.msi
[x64zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-x64.zip
[x86msi]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-x86.msi
[x86zip]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-x86.zip
[72x64msi]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-x64.msi
