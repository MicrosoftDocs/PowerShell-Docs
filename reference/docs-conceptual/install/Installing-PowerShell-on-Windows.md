...
- [PowerShell-7.3.3-win-x64.msi][28]
- [PowerShell-7.3.3-win-x86.msi][30]
...
- [PowerShell-7.3.3-win-x64.zip][29]
- [PowerShell-7.3.3-win-x86.zip][31]
- [PowerShell-7.3.3-win-arm64.zip][27]
...
> upgrades to the latest version of LTS, for example, from 7.2.3 to 7.2.10. To upgrade from an
...
$zipfile = 'PowerShell-7.3.3-win-arm64.zip'
...
Expand-Archive .\PowerShell-7.3.3-win-arm64.zip

# Set up remoting to PowerShell 7
Set-Location .\PowerShell-7.3.3-win-arm64
...
Enter-PSSession -ComputerName $deviceIp -Credential Administrator -Configuration PowerShell.7.3.3
```
...
$zipfile = 'PowerShell-7.3.3-win-x64.zip'
...
Expand-Archive -Path C:\PowerShell-7.3.3-win-x64.zip -DestinationPath 'C:\Program Files\PowerShell 7'
```
