...
There are several ways to install PowerShell on macOS. If you previously installed PowerShell using
Homebrew, see _Install on macOS using Homebrew_ in [Alternate ways to install PowerShell][03].
...
- PowerShell 7.6 (LTS)
  - Arm64 processors - [powershell-7.6.5-osx-arm64.pkg][13]
  - x64 processors - [powershell-7.6.5-osx-x64.pkg][15]
- PowerShell 7.5
  - Arm64 processors - [powershell-7.5.10-osx-arm64.pkg][09]
  - x64 processors - [powershell-7.5.10-osx-x64.pkg][11]
- PowerShell 7.4 (LTS)
  - Arm64 processors - [powershell-7.4.19-osx-arm64.pkg][05]
  - x64 processors - [powershell-7.4.19-osx-x64.pkg][07]
...
- PowerShell 7.6 (LTS)
  - Arm64 processors - [powershell-7.6.5-osx-arm64.tar.gz][14]
  - x64 processors - [powershell-7.6.5-osx-x64.tar.gz][16]
- PowerShell 7.5
  - Arm64 processors - [powershell-7.5.10-osx-arm64.tar.gz][10]
  - x64 processors - [powershell-7.5.10-osx-x64.tar.gz][12]
- PowerShell 7.4 (LTS)
  - Arm64 processors - [powershell-7.4.19-osx-arm64.tar.gz][06]
  - x64 processors - [powershell-7.4.19-osx-x64.tar.gz][08]
...
curl -L -o /tmp/powershell.tar.gz https://github.com/PowerShell/PowerShell/releases/download/v7.6.5/powershell-7.6.5-osx-arm64.tar.gz
...
[05]: https://github.com/PowerShell/PowerShell/releases/download/v7.4.19/powershell-7.4.19-osx-arm64.pkg
[06]: https://github.com/PowerShell/PowerShell/releases/download/v7.4.19/powershell-7.4.19-osx-arm64.tar.gz
[07]: https://github.com/PowerShell/PowerShell/releases/download/v7.4.19/powershell-7.4.19-osx-x64.pkg
[08]: https://github.com/PowerShell/PowerShell/releases/download/v7.4.19/powershell-7.4.19-osx-x64.tar.gz
[09]: https://github.com/PowerShell/PowerShell/releases/download/v7.5.10/powershell-7.5.10-osx-arm64.pkg
[10]: https://github.com/PowerShell/PowerShell/releases/download/v7.5.10/powershell-7.5.10-osx-arm64.tar.gz
[11]: https://github.com/PowerShell/PowerShell/releases/download/v7.5.10/powershell-7.5.10-osx-x64.pkg
[12]: https://github.com/PowerShell/PowerShell/releases/download/v7.5.10/powershell-7.5.10-osx-x64.tar.gz
[13]: https://github.com/PowerShell/PowerShell/releases/download/v7.6.5/powershell-7.6.5-osx-arm64.pkg
[14]: https://github.com/PowerShell/PowerShell/releases/download/v7.6.5/powershell-7.6.5-osx-arm64.tar.gz
[15]: https://github.com/PowerShell/PowerShell/releases/download/v7.6.5/powershell-7.6.5-osx-x64.pkg
[16]: https://github.com/PowerShell/PowerShell/releases/download/v7.6.5/powershell-7.6.5-osx-x64.tar.gz
