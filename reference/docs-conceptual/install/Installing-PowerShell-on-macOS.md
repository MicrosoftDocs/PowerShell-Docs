...
- PowerShell 7.2.6
  - x64 processors - [powershell-7.2.6-osx-x64.pkg][72x64pkg]
  - M1 processors - [powershell-7.2.6-osx-arm64.pkg][72m1pkg]
- PowerShell 7.0.12 - [powershell-7.0.12-osx-x64.pkg][70x64pkg]
...
> "powershell-7.2.6-osx-x64.pkg" can't be opened because Apple cannot check it for malicious
> software.
...
1. Run `sudo xattr -rd com.apple.quarantine powershell-7.2.6-osx-x64.pkg`. Include the full path to
   the `.pkg` file.
...
- PowerShell 7.2.6
  - x64 processors - [powershell-7.2.6-osx-x64.tar.gz][72x64bin]
  - M1 processors - [powershell-7.2.6-osx-arm64.tar.gz][72m1bin]
- PowerShell 7.0.12 - [powershell-7.0.12-osx-x64.tar.gz][70x64bin]
...
`$PSHOME` is `/usr/local/microsoft/powershell/7.2.6/`, and the symbolic link is placed at
`/usr/local/bin/pwsh`.
...
[72x64pkg]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-7.2.6-osx-x64.pkg
[72m1pkg]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-7.2.6-osx-arm64.pkg
[70x64pkg]: https://github.com/PowerShell/PowerShell/releases/download/v7.0.12/powershell-7.0.12-osx-x64.pkg

[72x64bin]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-7.2.6-osx-x64.tar.gz
[72m1bin]: https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/powershell-7.2.6-osx-arm64.tar.gz
[70x64bin]: https://github.com/PowerShell/PowerShell/releases/download/v7.0.12/powershell-7.0.12-osx-x64.tar.gz
