...
PowerShell 7.6.6 includes the following features, updates, and breaking changes. PowerShell
7.6.6 is built on the .NET 10.0.12 runtime.
...
PowerShell 7.6.6 includes the following updated modules:
