...
|          ModuleName / PSVersion           |   5.1    |   7.2    |   7.3    |                    Note                     |
| ----------------------------------------- | -------- | -------- | -------- | ------------------------------------------- |
...
| PSReadLine                                | v1.x     | v2.1     | v2.1     | New versions available from the Gallery     |
...
<!-- link references -->
[01]: /previous-versions/powershell/scripting/whats-new/what-s-new-in-powershell-70
