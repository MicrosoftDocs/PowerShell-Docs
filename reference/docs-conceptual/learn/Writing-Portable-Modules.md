...
PowerShell [SnapIns](/powershell/developer/cmdlet/modules-and-snap-ins) (PSSnapIn) aren't supported
in PowerShell Core. However, it's trivial to convert a PSSnapIn to a PowerShell module. Typically,
the PSSnapIn registration code is in a single source file of a class that derives from [PSSnapIn][].
