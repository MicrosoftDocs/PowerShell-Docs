...
`MenuComplete` function bound to <kbd>Ctrl</kbd>+<kbd>Space</kbd>. The `MenuComplete` function
...
also changes the case of letters to their standard form). If you press <kbd>Tab</kbd> key again,
