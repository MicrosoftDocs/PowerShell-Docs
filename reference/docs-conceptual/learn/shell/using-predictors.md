...
The previous image shows the default `InlineView` of the suggestion. Pressing <kbd>RightArrow</kbd>
...
might want to make <kbd>RightArrow</kbd> accept the next word of the inline suggestion, instead of
