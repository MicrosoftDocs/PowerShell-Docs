...
<kbd>2</kbd> key in `[System.ConsoleKey]` is `D2`, whereas the name of the <kbd>2</kbd> key on the
...
- <kbd>Ctrl</kbd>+<kbd>Spacebar</kbd> generates the key codes for <kbd>Ctrl</kbd>+<kbd>D2</kbd>. If
  you want to map a function to <kbd>Ctrl</kbd>+<kbd>Spacebar</kbd>, you must use the chord
  `Ctrl+D2`.
