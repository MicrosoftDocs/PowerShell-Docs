...
PowerShell 7.3 introduced a new feature `PSNativeCommandArgumentPassing` that improved native
command handling. For more information, see [`$PSNativeCommandArgumentPassing`][04].
