...
Allows you to iterate over all elements in the array and perform a given operation
...
Allows you to filter or select the elements of the array. The script must evaluate
