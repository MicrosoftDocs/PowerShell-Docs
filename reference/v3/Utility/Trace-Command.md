...
```
Trace-Command [-Name] <String[]> [-Expression] <ScriptBlock> [[-Option] <PSTraceSourceOptions>] [-Debugger]
 [-FilePath <String>] [-Force] [-InputObject <PSObject>] [-ListenerOption <TraceOptions>] [-PSHost]
```

### UNNAMED_PARAMETER_SET_2
```
Trace-Command [-Name] <String[]> [-Command] <String> [[-Option] <PSTraceSourceOptions>]
 [-ArgumentList <Object[]>] [-Debugger] [-FilePath <String>] [-Force] [-InputObject <PSObject>]
 [-ListenerOption <TraceOptions>] [-PSHost]
```
