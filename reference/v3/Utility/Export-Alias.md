...
```
Export-Alias [-Path] <String> [[-Name] <String[]>] [-Append] [-As <ExportAliasFormat>] [-Description <String>]
 [-Force] [-NoClobber] [-PassThru] [-Scope <String>] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Export-Alias [[-Name] <String[]>] [-Append] [-As <ExportAliasFormat>] [-Description <String>] [-Force]
 [-NoClobber] [-PassThru] [-Scope <String>] -LiteralPath <String> [-Confirm] [-WhatIf]
```
