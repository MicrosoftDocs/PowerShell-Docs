...
```
Out-File [-FilePath] <String> [[-Encoding] <String>] [-Append] [-Force] [-InputObject <PSObject>] [-NoClobber]
 [-Width <Int32>] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Out-File [[-Encoding] <String>] [-Append] [-Force] [-InputObject <PSObject>] [-NoClobber] [-Width <Int32>]
