...
```
Import-Counter [-Path] <String[]> [-Counter <String[]>] [-EndTime <DateTime>] [-MaxSamples <Int64>]
 [-StartTime <DateTime>]
```

### UNNAMED_PARAMETER_SET_2
```
Import-Counter [-Path] <String[]> -ListSet <String[]>
```

### UNNAMED_PARAMETER_SET_3
```
Import-Counter [-Path] <String[]> [-Summary]
```
