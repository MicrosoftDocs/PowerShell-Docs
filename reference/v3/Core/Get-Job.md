...
```
Get-Job [[-Id] <Int32[]>] [-After <DateTime>] [-Before <DateTime>] [-ChildJobState <JobState>]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_2
```
Get-Job [-After <DateTime>] [-Before <DateTime>] [-ChildJobState <JobState>] [-Command <String[]>]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```
...
```
Get-Job [-State] <JobState> [-After <DateTime>] [-Before <DateTime>] [-ChildJobState <JobState>]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_5
```
Get-Job [-Name] <String[]> [-After <DateTime>] [-Before <DateTime>] [-ChildJobState <JobState>]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```

### UNNAMED_PARAMETER_SET_6
```
Get-Job [-InstanceId] <Guid[]> [-After <DateTime>] [-Before <DateTime>] [-ChildJobState <JobState>]
 [-HasMoreData <Boolean>] [-IncludeChildJob] [-Newest <Int32>]
```
