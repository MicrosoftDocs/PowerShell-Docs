...
New-PSSession [[-ComputerName] <String[]>] [-ApplicationName <String>]
 ...
 [-Credential <PSCredential>] [-EnableNetworkAccess] [-Name <String[]>] [-Port <Int32>]
 [-SessionOption <PSSessionOption>] [-ThrottleLimit <Int32>] [-UseSSL]
```

### UNNAMED_PARAMETER_SET_2
```
New-PSSession [-ConnectionUri] <Uri[]> [-AllowRedirection] [-Authentication <AuthenticationMechanism>]
 [-CertificateThumbprint <String>] [-ConfigurationName <String>] [-Credential <PSCredential>]
 [-EnableNetworkAccess] [-Name <String[]>] [-SessionOption <PSSessionOption>] [-ThrottleLimit <Int32>]
```
