...
```
Connect-PSSession [-ConnectionUri] <Uri[]> [-AllowRedirection] [-Authentication <AuthenticationMechanism>]
...
```
Connect-PSSession [-ComputerName] <String[]> [-ApplicationName <String>]
 [-Authentication <AuthenticationMechanism>] [-CertificateThumbprint <String>] [-ConfigurationName <String>]
 [-Credential <PSCredential>] [-Name <String[]>] [-Port <Int32>] [-SessionOption <PSSessionOption>]
 [-ThrottleLimit <Int32>] [-UseSSL] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_4
```
Connect-PSSession [-ApplicationName <String>] [-Authentication <AuthenticationMechanism>]
 [-CertificateThumbprint <String>] [-ConfigurationName <String>] [-Credential <PSCredential>] [-Port <Int32>]
 [-SessionOption <PSSessionOption>] [-ThrottleLimit <Int32>] [-UseSSL] [-ComputerName] <String[]>
