...
documented examples of how to use that in the [`Set-PSReadLineOption`](MicrosoftDocs/PowerShell-Docs/reference/7.3/PSReadLine/Set-PSReadLineOption.md) doc page.
