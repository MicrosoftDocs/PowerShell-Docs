...
ms.date: 02/27/2023
online version: https://learn.microsoft.com/powershell/module/microsoft.powershell.utility/trace-command?view=powershell-7.2&WT.mc_id=ps-gethelp
schema: 2.0.0
title: Trace-Command
---
...
PowerShell 7.2 added the `PSNativeCommandArgumentPassing` experimental feature. This feature adds
the ability to trace parameter binding for native commands. The following example shows how
PowerShell parses the command-line arguments for the native command `TestExe`.
...
[Using experimental features](/powershell/scripting/learn/experimental-features#psnativecommandargumentpassing).
