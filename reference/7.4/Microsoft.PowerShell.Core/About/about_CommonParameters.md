...
For more information, see [about_Preference_Variables][02].
...
`$InformationPreference`, see [about_Preference_Variables][02].
...
> [Advanced functions][01]. PowerShell 7.2 corrects this behavior.
...
[Write-Progress][07] cmdlet. The `Write-Progress` cmdlet creates progress bars
that show a command's status.

The **ProgressAction** parameter takes one of the [`ActionPreference`][10]
...
information, see [about_Preference_Variables][04]
...
[05]: xref:Microsoft.PowerShell.Utility.Write-Debug
[06]: xref:Microsoft.PowerShell.Utility.Write-Error
[07]: xref:Microsoft.PowerShell.Utility.Write-Progress
[08]: xref:Microsoft.PowerShell.Utility.Write-Verbose
[09]: xref:Microsoft.PowerShell.Utility.Write-Warning
[10]: xref:System.Management.Automation.ActionPreference
