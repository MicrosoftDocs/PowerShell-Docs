...
```
Set-PSRepository [-InstallationPolicy] [-PackageManagementProvider <String>] [-PublishLocation <Uri>]
 [-ScriptPublishLocation <Uri>] [-ScriptSourceLocation <Uri>] [-SourceLocation <Uri>] -Name <String>
```
