...
```
Register-PSRepository [-InstallationPolicy] [-PackageManagementProvider <String>] [-PublishLocation <Uri>]
 [-ScriptPublishLocation <Uri>] [-ScriptSourceLocation <Uri>] -Name <String> -SourceLocation <Uri>
```
