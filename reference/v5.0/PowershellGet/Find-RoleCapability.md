...
online version: http://go.microsoft.com/fwlink/?LinkId=718029
schema: 2.0.0
---
...
```
Find-RoleCapability [[-Name] <String[]>] [-AllVersions] [-Filter <String>] [-MinimumVersion <Version>]
 [-ModuleName <String>] [-Repository <String[]>] [-RequiredVersion <Version>] [-Tag <String[]>]
```
