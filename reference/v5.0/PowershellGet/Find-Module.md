...
```
Find-Module [[-Name] <String[]>] [-AllVersions] [-Command <String[]>] [-DscResource <String[]>]
 [-Filter <String>] [-IncludeDependencies] [-Includes] [-MaximumVersion <Version>] [-MinimumVersion <Version>]
 [-Repository <String[]>] [-RequiredVersion <Version>] [-RoleCapability <String[]>] [-Tag <String[]>]
```
