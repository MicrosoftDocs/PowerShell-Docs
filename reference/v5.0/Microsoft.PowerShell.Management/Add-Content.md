...
```
Add-Content [-Path] <String[]> [-Value] <Object[]> [-Credential <PSCredential>] [-Encoding]
 [-Exclude <String[]>] [-Filter <String>] [-Force] [-Include <String[]>] [-NoNewline] [-PassThru]
 [-Stream <System.String>] [-Confirm] [-WhatIf] [-UseTransaction]
```

### UNNAMED_PARAMETER_SET_2
```
Add-Content [-Value] <Object[]> [-Credential <PSCredential>] [-Encoding] [-Exclude <String[]>]
 [-Filter <String>] [-Force] [-Include <String[]>] [-NoNewline] [-PassThru] [-Stream <System.String>]
