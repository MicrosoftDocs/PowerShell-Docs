...
```
Stop-Computer [[-ComputerName] <String[]>] [[-Credential] <PSCredential>] [-AsJob] [-DcomAuthentication]
 [-Force] [-Impersonation] [-Protocol] [-ThrottleLimit <Int32>] [-WsmanAuthentication] [-Confirm] [-WhatIf]
```
