...
```
Register-ObjectEvent [-InputObject] <PSObject> [[-SourceIdentifier] <String>] [[-Action] <ScriptBlock>]
 [-EventName] <String> [-Forward] [-MaxTriggerCount <System.Int32>] [-MessageData <PSObject>] [-SupportEvent]
```
