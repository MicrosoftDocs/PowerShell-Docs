...
```
Export-Clixml [-Path] <String> [-Depth <Int32>] [-Encoding] [-Force] [-NoClobber] -InputObject <PSObject>
 [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Export-Clixml [-Depth <Int32>] [-Encoding] [-Force] [-NoClobber] -InputObject <PSObject> -LiteralPath <String>
 [-Confirm] [-WhatIf]
```
