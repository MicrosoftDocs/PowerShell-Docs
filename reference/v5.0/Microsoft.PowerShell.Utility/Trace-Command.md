...
```
Trace-Command [-Name] <String[]> [-Expression] <ScriptBlock> [-Option] [-Debugger] [-FilePath <String>]
 [-Force] [-InputObject <PSObject>] [-ListenerOption] [-PSHost]
```

### UNNAMED_PARAMETER_SET_2
```
Trace-Command [-Name] <String[]> [-Command] <String> [-Option] [-ArgumentList <Object[]>] [-Debugger]
 [-FilePath <String>] [-Force] [-InputObject <PSObject>] [-ListenerOption] [-PSHost]
```
...
[Find-Command](c0383a4f-695e-4041-9255-b31c3960411f)
...
[Measure-Command](4af58dce-fb25-4969-aaa8-463e7be342db)

[Set-TraceSource](442780bb-7332-4995-b583-6e07889d1e26)

[Show-Command](65bba50b-91a8-49d5-80a2-a30fc684ba41)
