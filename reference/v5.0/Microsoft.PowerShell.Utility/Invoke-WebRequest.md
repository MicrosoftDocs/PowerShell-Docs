...
Invoke-WebRequest [-Uri] <Uri> [-Body <Object>] [-Certificate <X509Certificate>]
 ...
 [-Headers <IDictionary>] [-InFile <String>] [-MaximumRedirection <Int32>] [-Method] [-OutFile <String>]
 [-PassThru] [-Proxy <Uri>] [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials]
 [-SessionVariable <String>] [-TimeoutSec <Int32>] [-TransferEncoding] [-UseBasicParsing]
