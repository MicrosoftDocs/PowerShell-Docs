...
```
Out-File [-FilePath] <String> [-Encoding] [-Append] [-Force] [-InputObject <PSObject>] [-NoClobber]
 [-NoNewline] [-Width <Int32>] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Out-File [-Encoding] [-Append] [-Force] [-InputObject <PSObject>] [-NoClobber] [-NoNewline] [-Width <Int32>]
