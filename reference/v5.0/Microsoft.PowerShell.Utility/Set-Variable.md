...
```
Set-Variable [-Name] <String[]> [[-Value] <Object>] [-Description <String>] [-Exclude <String[]>] [-Force]
 [-Include <String[]>] [-Option] [-PassThru] [-Scope <String>] [-Visibility] [-Confirm] [-WhatIf]
```
...
Valid values are: The acceptable values for this parameter are:
