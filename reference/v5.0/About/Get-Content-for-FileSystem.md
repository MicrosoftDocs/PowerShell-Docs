...
## Description  
 In file system drives, you can use the [Get-Content](Get-Content.md) cmdlet to get content that you display at the command line, save in a variable for processing, or write to another file. It is not valid on folders.  
...
### \-Force  
 Gets the contents of all files, including hidden files. By default, [Get-Content](Get-Content.md) does not get the contents of hidden files unless you specify the hidden file by name.  
