...
```
Save-Package [[-Name] <String[]>] [-AllVersions] [-MaximumVersion <String>] [-MinimumVersion <String>]
 [-Path <String>] [-ProviderName] [-RequiredVersion <String>] [-Source <String[]>] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Save-Package [-AllVersions] [-Credential <PSCredential>] [-Force] [-ForceBootstrap] [-LiteralPath <String>]
 [-Path <String>] -InputObject <SoftwareIdentity> [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_3
```
Save-Package [-AllVersions] [-Command <String[]>] [-DscResource <String[]>] [-Filter <String>] [-Includes]
 [-PackageManagementProvider <String>] [-Path <String>] [-PublishLocation <String>]
