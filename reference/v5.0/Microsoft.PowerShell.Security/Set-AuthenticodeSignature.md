...
```
Set-AuthenticodeSignature [-FilePath] <String[]> [-Certificate] <X509Certificate2> [-Force]
 [-HashAlgorithm <String>] [-IncludeChain <String>] [-TimestampServer <String>] [-Confirm] [-WhatIf]
```

### UNNAMED_PARAMETER_SET_2
```
Set-AuthenticodeSignature [-Certificate] <X509Certificate2> [-Force] [-HashAlgorithm <String>]
 [-IncludeChain <String>] [-TimestampServer <String>] -LiteralPath <String[]> [-Confirm] [-WhatIf]
```
...
[Get-PfxCertificate](2f08fac8-2872-4a11-930e-af03a8c4a00d)
