...
An alternative to Basic Authentication over HTTPS is Negotiate. The results
in NTLM authentication with client and server payload encryption over HTTP.
The following example illustrates using Negotiate with New-PSSession:
