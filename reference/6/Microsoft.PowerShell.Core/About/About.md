...
An enumeration is a distinct type that consists of a set of named labels called the enumerator list.

### [about_Environment_Provider](about_Environment_Provider.md)

Provides access to the Environment variables and the values that they represent.
...
Provides access to the FileSystem objects.
...
Provides access to the PowerShell Functions.
