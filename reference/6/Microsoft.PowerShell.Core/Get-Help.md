...
you have to use a cmdlet that transforms the help topic content into a string,
...
When you enter a word that does not appear in any topic title, **Get-Help** displays a list
of topics that include that word.
...
path, see 
[New-Item for ClientCertificate](http://go.microsoft.com/fwlink/?LinkID=158676) in the TechNet library.
...
For example, you can find help for the **New-Item** cmdlet in the Wsman:\*\ClientCertificate path[http://go.microsoft.com/fwlink/?LinkID=158676](http://go.microsoft.com/fwlink/?LinkID=158676)
