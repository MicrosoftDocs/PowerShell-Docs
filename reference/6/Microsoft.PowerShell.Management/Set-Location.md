...
locale: en-us
ms.date: 08/26/2019
online version: https://docs.microsoft.com/powershell/module/microsoft.powershell.management/set-location?view=powershell-6
schema: 2.0.0
title: Set-Location
---
# Set-Location
...
except that the history is a list, not a stack, and there is no way to display this history list.
