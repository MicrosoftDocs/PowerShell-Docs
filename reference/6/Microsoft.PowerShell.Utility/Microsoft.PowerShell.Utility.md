...
## Description
This section contains the help topics for the cmdlets that are installed with PowerShell Utility module, Microsoft.PowerShell.Utility. The Utility module contains cmdlets that manage the basic features of PowerShell.
...
Adds a Microsoft .NET Framework type (a class) to a PowerShell session.
