...
This section contains the help topics for the **Microsoft.WSMan.Management** module, which contains the [WSMan Provider [v3]](https://technet.microsoft.com/en-us/library/4c3d8d36-4f7a-4211-996f-64110e4b2eb7) and cmdlets that manage Web Services for Management (WS\-Management) and Windows Remote Management (WinRM). The **Microsoft.WSMan.Management** module is installed with [!INCLUDE[mshshort](../Token/mshshort_md.md)].
