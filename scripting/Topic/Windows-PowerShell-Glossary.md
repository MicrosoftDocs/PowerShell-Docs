...
|[!INCLUDE[wps_2](../Token/wps_2_md.md)] Workflow|A workflow is a sequence of programmed, connected steps that perform long\-running tasks or require the coordination of multiple steps across multiple devices or managed nodes. [!INCLUDE[wps_2](../Token/wps_2_md.md)] Workflow lets IT pros and developers author sequences of multi\-device management activities, or single tasks within a workflow, as workflows. [!INCLUDE[wps_2](../Token/wps_2_md.md)] Workflow lets you adapt and run both [!INCLUDE[wps_2](../Token/wps_2_md.md)] scripts and XAML files as workflows.|
